...
`;let ut=class extends ht{constructor(){super(...arguments),this.MOINSTURE="moisture",this.CONDUCTIVITY="conductivity",this.BRIGHTNESS="brightness",this.TEMPERATURE="temperature",this.BATTERY="battery"}getCardSize(){return 1}static get styles(){return pt}setConfig(t){if(console.log({flora_care_card_config:t}),!t)throw new Error("Invalid configuration");if(!t.entity)throw new Error("entity is required");this._config=t}render(){return null==this.hass.states[this._config.entity]?O`
            <ha-card>
                <div class='banner'>
        ...
        `:this._render()}_render(){if(null==this.hass.states[this._config.entity])throw new Error("entity is required");return this._floraCare=this.hass.states[this._config.entity],this._floraRanges=this._floraCare.attributes.ranges,O`
      <ha-card style="background-image:url(${this._floraCare.attributes.image})">
        ...
        `}computeBanner(t){return t.toLowerCase,this.computeFullBanner()}computeFullBanner(){return O`
            <div class="header">${this.computeTitle()}</div>
        `}computeTitle(){return this._config&&this._config.name}computeContentItem(t,e,s,i){return O`
