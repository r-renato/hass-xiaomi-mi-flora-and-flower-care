...
`;console.info("%c XIAOMI-MI-FLORA-AND-FLOWER-CARE-CARD %c 1.2.0 ","color: white; background: green; font-weight: 700;","color: coral; background: white; font-weight: 700;");let ut=class extends ct{constructor(){super(...arguments),this.invalidConfig=!1,this.invalidEntity=!1,this.displayInfo=!1,this.displayMaintenance=!1,this.MOINSTURE="moisture",this.CONDUCTIVITY="conductivity",this.BRIGHTNESS="brightness",this.TEMPERATURE="temperature",this.BATTERY="battery"}setConfig(t){if(console.log({flora_care_card_config:t}),!t)throw this.invalidConfig=!0,new Error("Invalid configuration");if(!t.entity||0==t.entity.length)throw this.invalidEntity=!0,new Error("Entity is required");if(t.display&&t.display.length>0){let e=t.display.map(function(t){return t.toLocaleLowerCase()});this.displayMaintenance=e.includes("maintenance"),this.displayInfo=e.includes("info")}this._config=t}getCardSize(){return 1}static get styles(){return pt}render(){return this.invalidConfig||this.invalidEntity?V`
        ...
        `:this._render()}_render(){this._floraCare=this.hass.states[this._config.entity],this._floraRanges=this._floraCare.attributes.ranges;let t=this.computeContent(),e=""!==t.strings.raw.toString(),s=this.displayInfo&&(this.displayMaintenance||e)?"banner div-border-bottom":"banner",i=this.displayMaintenance&&e?"banner div-border-bottom":"banner";return V`
      <ha-card style="background-image:url(${this._floraCare.attributes.image});background-repeat: no-repeat;background-size: auto !important;">
        ...
        `}computeContent(){let t=this.getSensor(this._floraCare.attributes.sensors[this.MOINSTURE]),e=this.getSensor(this._floraCare.attributes.sensors[this.CONDUCTIVITY]),s=this.getSensor(this._floraCare.attributes.sensors[this.BRIGHTNESS]),i=this.getSensor(this._floraCare.attributes.sensors[this.TEMPERATURE]);return t||e||s||i?V`
                ${t?this.computeContentItem(t,this._floraRanges.min_soil_moist,this._floraRanges.max_soil_moist,this.computeAttributeClass(this._floraCare.attributes.problem,t,this.MOINSTURE)):V``}
                ${e?this.computeContentItem(e,this._floraRanges.min_soil_ec,this._floraRanges.max_soil_ec,this.computeAttributeClass(this._floraCare.attributes.problem,e,this.CONDUCTIVITY)):V``}
                ${s?this.computeContentItem(s,this._floraRanges.min_light_lux,this._floraRanges.max_light_lux,this.computeAttributeClass(this._floraCare.attributes.problem,s,this.BRIGHTNESS)):V``}
                ${i?this.computeContentItem(i,this._floraRanges.min_temp,this._floraRanges.max_temp,this.computeAttributeClass(this._floraCare.attributes.problem,i,this.TEMPERATURE)):V``}
            `:V``}computeTitle(){return this._config&&this._config.name}computeContentItem(t,e,s,i){return void 0!==t?V`
            ...
            <table is="s-table-lite">
                <tbody>
                    <tr>
                        ...
                        <td>
                        ${this.computeContentItem(t,null,null,this.computeAttributeClass(this._floraCare.attributes.problem,t,this.BATTERY))}  
                        </td>
                    </tr>
                    <tr>
        ...
        `}computeAttributeClass(t,e,s){return-1===t.indexOf(s)&&void 0!==e&&-1===e.state.indexOf("unknown")?"":"problem"}getSensor(t){return this.hass.states[t]}capitalize(t){return t.charAt(0).toUpperCase()+t.slice(1)}};t([nt()],ut.prototype,"hass",void 0),t([nt()],ut.prototype,"_config",void 0),t([nt()],ut.prototype,"_floraCare",void 0),t([nt()],ut.prototype,"_floraRanges",void 0),ut=t([(t=>e=>"function"==typeof e?((t,e)=>(window.customElements.define(t,e),e))(t,e):((t,e)=>{const{kind:s,elements:i}=e;return{kind:s,elements:i,finisher(e){window.customElements.define(t,e)}}})(t,e))("xiaomi-mi-flora-and-flower-care-card")],ut);
